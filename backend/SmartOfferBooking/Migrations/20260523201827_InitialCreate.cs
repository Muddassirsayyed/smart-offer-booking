    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2026, 5, 23, 20, 18, 26, 923, DateTimeKind.Utc).AddTicks(3808), "admin@smartoffer.com", true, "Admin User", "$2a$11$96a5Vss1wSbmmbkZp5pmU.2Uap.pe4s7Gig24pfCbuPIYUWXtxXDy", "9999999999", "Admin", new DateTime(2026, 5, 23, 20, 18, 26, 923, DateTimeKind.Utc).AddTicks(3815) });

            migrationBuilder.InsertData(
                table: "Businesses",
                columns: new[] { "Id", "Address", "BusinessName", "BusinessType", "City", "ClosingTime", "CreatedAt", "Email", "IsActive", "LogoUrl", "OpeningTime", "OwnerName", "Phone", "UpdatedAt", "UserId" },
                values: new object[] { 1, "123 Main Street", "FitZone Gym", "Gym", "Mumbai", new TimeOnly(22, 0, 0), new DateTime(2026, 5, 23, 20, 18, 26, 923, DateTimeKind.Utc).AddTicks(4662), "admin@smartoffer.com", true, null, new TimeOnly(6, 0, 0), "Admin User", "9999999999", new DateTime(2026, 5, 23, 20, 18, 26, 923, DateTimeKind.Utc).AddTicks(4662), 1 });
